...
bool send_reset_email(const EmailConfig &cfg, const std::string &to, const std::string &reset_url)
{
    ...
    std::string body = "You requested a password reset. Click the link below to reset your password:\n\n" +
                       reset_url + "\n\n" +
    ...
    {
        return send_email_via_mailgun(cfg, to, subject, body);
    }

    return false;
}

// generated by chatgpt, meant to deliver email via mailgun api
